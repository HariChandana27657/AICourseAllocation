...
const insertSampleData = async () => {
  return new Promise((resolve, reject) => {
    ...
    db.get('SELECT COUNT(*) as count FROM courses', async (err, row) => {
      ...
      const studentData = [
        ['K N S Hari Chandana', 'hari@gmail.com', 'Computer Science', 7.99, await bcrypt.hash('231FA04H02', 10)],
        ['G SivaMani', 'siva@gmail.com', 'Computer Science', 8.21, await bcrypt.hash('231FA04409', 10)],
        ['M Nikhitha', 'nikki@gmail.com', 'Mathematics', 8.03, await bcrypt.hash('231FA04C43', 10)],
        ['D Sarayu', 'saru@gmail.com', 'Physics', 7.99, await bcrypt.hash('231FA04D96', 10)],
        ['K Kedareswar', 'KD@gmail.com', 'Computer Science', 9.0, await bcrypt.hash('student123', 10)],
      ];
      ...
      db.serialize(() => {
        ...
        courses.forEach(c => db.run(`INSERT INTO courses (course_code, course_name, department, instructor, seat_capacity, time_slot, description) VALUES (?,?,?,?,?,?,?)`, c));
        ...
        db.run(`INSERT INTO prerequisites (course_id, prerequisite_course_id) VALUES (2,1)`);
        db.run(`INSERT INTO prerequisites (course_id, prerequisite_course_id) VALUES (3,2)`);
        db.run(`INSERT INTO prerequisites (course_id, prerequisite_course_id) VALUES (5,4)`, (err) => {
